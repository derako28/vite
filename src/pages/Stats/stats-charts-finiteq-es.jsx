...
const filterOptions = [
    ...
    { id: 'isTestVA', title: 'Test VA', type: FILTER_TYPES.SELECT, options: getOptions(TEST_OPTIONS) },
    { id: 'isTestPOC', title: 'Test POC', type: FILTER_TYPES.SELECT, options: getOptions(TEST_OPTIONS) },
    { id: 'isTestIB', title: 'Test IB', type: FILTER_TYPES.SELECT, options: getOptions(TEST_OPTIONS) },
...
const columns =  [
    { id: 'TPO_Date', title: 'Date', type: FILTER_TYPES.DATEPICKER_RANGE },
    { id: 'open_relation', title: 'Open Relation', type: FILTER_TYPES.SELECT, options: getOptions(OPENS_OPTIONS) },
    { id: 'close_relation', title: 'Close Relation', type: FILTER_TYPES.SELECT, options: getOptions(OPENS_OPTIONS) },
