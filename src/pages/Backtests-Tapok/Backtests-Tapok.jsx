...
const initialData = segmentData(mergeStatsAndBack(sortByDate(dataStats), sortByDate(dataBacktest)))



const optimizedData = segmentData(mergeStatsAndBack(sortByDate(dataStats), sortByDate(dataBacktest)))
